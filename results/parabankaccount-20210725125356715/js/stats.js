...
contents: {
"req_loginrequest-2c0db": {
        type: "REQUEST",
        name: "LoginRequest",
path: "LoginRequest",
pathFormatted: "req_loginrequest-2c0db",
stats: {
    "name": "LoginRequest",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_logorequest-0b87a": {
        type: "REQUEST",
        name: "LogoRequest",
path: "LogoRequest",
pathFormatted: "req_logorequest-0b87a",
stats: {
    "name": "LogoRequest",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_get-account-req-a8119": {
        type: "REQUEST",
        name: "GET_ACCOUNT_REQUEST_PARA_BANK",
path: "GET_ACCOUNT_REQUEST_PARA_BANK",
pathFormatted: "req_get-account-req-a8119",
stats: {
    "name": "GET_ACCOUNT_REQUEST_PARA_BANK",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_create-account--199b5": {
        type: "REQUEST",
        name: "CREATE_ACCOUNT_REQUEST",
path: "CREATE_ACCOUNT_REQUEST",
pathFormatted: "req_create-account--199b5",
stats: {
    "name": "CREATE_ACCOUNT_REQUEST",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_angular-min-js-59efd": {
        type: "REQUEST",
        name: "angular.min.js",
path: "angular.min.js",
pathFormatted: "req_angular-min-js-59efd",
stats: {
    "name": "angular.min.js",
    "numberOfRequests": {
        "total": "1",
    ...
    },"req_template-css-ca76a": {
        type: "REQUEST",
        name: "template.css",
path: "template.css",
pathFormatted: "req_template-css-ca76a",
stats: {
    "name": "template.css",
    "numberOfRequests": {
        "total": "1",
    ...
    },"req_header-main-jpg-9730c": {
        type: "REQUEST",
        name: "header-main.jpg",
path: "header-main.jpg",
pathFormatted: "req_header-main-jpg-9730c",
stats: {
    "name": "header-main.jpg",
    "numberOfRequests": {
        "total": "1",
    ...
    "meanNumberOfRequestsPerSecond": {
        ...
        name: "logo.gif",
path: "logo.gif",
pathFormatted: "req_logo-gif-38bfb",
stats: {
    "name": "logo.gif",
    "numberOfRequests": {
        "total": "1",
    ...
    "meanNumberOfRequestsPerSecond": {
        ...
        name: "clear.gif",
path: "clear.gif",
pathFormatted: "req_clear-gif-b8dfd",
stats: {
    "name": "clear.gif",
    "numberOfRequests": {
        "total": "1",
